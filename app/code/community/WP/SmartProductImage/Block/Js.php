...
class WP_SmartProductImage_Block_Js extends Mage_Catalog_Block_Product_View_Abstract {
    ...
    public function _prepareLayout() {
        if (!Mage::getStoreConfig('smart_product_image/general/enabled'))
            return;
    ...
    public function getViewportWidthArray() {
        ...
        if (isset($imageSizes['viewport_width_array']) && is_array($imageSizes['viewport_width_array']) && count($imageSizes['viewport_width_array'])) {
    ...
    public function getImagesArray() {
        $imageSizes = $this->getImageSizes();
        if (isset($imageSizes['image_width_array']) && is_array($imageSizes['image_width_array']) && count($imageSizes['image_width_array'])) {
