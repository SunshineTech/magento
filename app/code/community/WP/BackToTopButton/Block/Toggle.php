...
class WP_BackToTopButton_Block_Toggle extends Mage_Core_Block_Template {
    ...
    public function _prepareLayout() {
        if (Mage::helper('backtotopbutton')->isDisabled())
            return;
        ...
        if (is_object($beforeBodyEnd)) {
            ...
            // --- js ---
            if (Mage::getStoreConfigFlag('design/backtotopbutton/include_jquery')) {
            ...
            if (Mage::getStoreConfigFlag('design/backtotopbutton/include_waypoints')) {
