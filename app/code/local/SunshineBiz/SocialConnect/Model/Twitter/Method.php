 ...
 */
class SunshineBiz_SocialConnect_Model_Twitter_Method extends SunshineBiz_SocialConnect_Model_Method_Abstract {

    protected $_code = 'twitter';
    protected $_buttonBlockType = 'socialconnect/twitter_button';
    protected $_accountUrl = 'socialconnect/account/twitter';
    ...
    public function api($endpoint, $method = 'GET', $params = array()) {
        if (empty($this->token)) {
            throw new Exception(Mage::helper('socialconnect')->__('Unable to proceeed without an access token.'));
        }
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array()) {
        ...
        if ($response->isError()) {
            ...
            if (($status == 400 || $status == 401 || $status == 429)) {
                ...
                throw new SunshineBiz_SocialConnect_TwitterOAuthException($message);
            } else {
    ...
    public function getDescription() {
        return Mage::helper('socialconnect')->__('You can login or register using your <strong>Twitter</strong> credentials.');
    }
    ...
    public function getTitle() {
        return Mage::helper('socialconnect')->__('Twitter Connect');
    }

}

class SunshineBiz_SocialConnect_TwitterOAuthException extends Exception {
