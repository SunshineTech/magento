...
/**
 * SunshineBiz_Adminhtml User controller
 *
...
class SunshineBiz_Adminhtml_Permissions_UserController extends Mage_Adminhtml_Permissions_UserController {
    ...
    public function resourcesAction() {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()
                ->createBlock('sunshinebiz_adminhtml/permission_user_edit_tab_resources')
                ->toHtml()
        );
    }
}
