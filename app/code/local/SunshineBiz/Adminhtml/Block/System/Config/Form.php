 ...
 */
class SunshineBiz_Adminhtml_Block_System_Config_Form extends Mage_Adminhtml_Block_System_Config_Form {
        ...
        foreach ($group->fields as $elements) {
            ...
            foreach ($elements as $element) {
                ...
                $field = $fieldset->addField($id, $fieldType, array(
                    'name' => $name,
                    'label' => $label,
                    'required' => $element->required, //add <required></required> label
                    'comment' => $comment,
                    'tooltip' => $tooltip,
                    'hint' => $hint,
                    'value' => $data,
    ...
    protected function _getAdditionalElementTypes() {
        ...
        $array['logo'] = Mage::getConfig()->getBlockClassName('sunshinebiz_adminhtml/system_config_form_field_logo');
