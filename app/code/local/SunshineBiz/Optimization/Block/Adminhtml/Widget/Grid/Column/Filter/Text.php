 ...
 */
class SunshineBiz_Optimization_Block_Adminhtml_Widget_Grid_Column_Filter_Text extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Text {
    ...
    public function getHtml() {
        ...
        $html .= '<option value="any"'. ($position === 'any' ? 'selected="selected"' : '') .'>'.$this->escapeHtml(Mage::helper('optimization')->__("Include")).'</option>';
        $html .= '<option value="start"'. ($position === 'start' ? 'selected="selected"' : '') .'>'.$this->escapeHtml(Mage::helper('optimization')->__("Start with")).'</option>';
        $html .= '<option value="end"'. ($position === 'end' ? 'selected="selected"' : '') .'>'.$this->escapeHtml(Mage::helper('optimization')->__("End with")).'</option>';
        $html.='</select>';
