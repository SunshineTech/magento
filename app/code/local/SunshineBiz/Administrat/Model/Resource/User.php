...
/**
 * SunshineBiz_Administrat user resource
 *
 ...
 */
class SunshineBiz_Administrat_Model_Resource_User extends Mage_Admin_Model_Resource_User {
    ...
    public function getUserRules(Mage_Core_Model_Abstract $user) {
        ...
        $select = $adapter->select()
                ->from($this->getTable('administrat/user_rule'), array('rule_id', 'resource_id', 'permission'))
