 ...
 */
class SunshineBiz_Administrat_Block_Adminhtml_Permission_User_Edit_Tab_Main extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('user_roles_old', 'hidden', array(
            'name' => 'user_roles_old',
            'id'   => '_user_roles_old',
        ));
