...
/**
 * Create table 'sunshinebiz_admin/user_rule'
 */
$table = $installer->getConnection()
        ->newTable($installer->getTable('sunshinebiz_admin/user_rule'))
        ...
        ->addIndex($installer->getIdxName('sunshinebiz_admin/user_rule', array('resource_id', 'user_id')), array('resource_id', 'user_id'))
        ->addIndex($installer->getIdxName('sunshinebiz_admin/user_rule', array('user_id', 'resource_id')), array('user_id', 'resource_id'))
        ->addForeignKey($installer->getFkName('sunshinebiz_admin/user_rule', 'user_id', 'admin/user', 'user_id'),
