...
/**
 * SunshineBiz_Catalog product controller
 *
...
class SunshineBiz_Catalog_ProductController extends Mage_Catalog_ProductController {
    ...
    public function quickViewAction() {
        ...
        if ($product = $this->_initProduct()) {
            ...
            if ($product->isSaleable()) {
                $result .= "<button class='button' onclick=\"setLocation('" . Mage::helper('checkout/cart')->getAddUrl($product) . "')\"><span><span>" . Mage::helper('catalog')->__('Add to Cart') . "</span></span></button>&nbsp;" . Mage::helper('catalog')->__('OR') . '&nbsp;';
            }
