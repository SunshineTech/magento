 ...
 */
class SunshineBiz_Location_Block_Adminhtml_Building_Grid extends SunshineBiz_Location_Block_Adminhtml_Widget_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('location/building')->getCollection();
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('area_id', array(
            ...
            'index' => 'area_id',
            'filter' => 'location/adminhtml_widget_grid_column_filter_area',
        ...
        $this->addColumn('circle_id', array(
            ...
            'index' => 'circle_id',
            'filter' => 'location/adminhtml_widget_grid_column_filter_circle',
            'renderer' => 'location/adminhtml_widget_grid_column_renderer_area',
        ));
