...
class SunshineBiz_Location_Model_Resource_Building extends SunshineBiz_Locale_Model_Resource_Abstract {
    ...
    protected function _construct() {
        ...
        $this->_init('location/building', 'id');
        $this->_nameTable = $this->getTable('location/building_name');
    ...
    protected function _beforeSave(Mage_Core_Model_Abstract $building) {
        ...
        if (!$building->getId()) {
            $building->setCreatedAt(Mage::getSingleton('core/date')->gmtDate());
        }

        $building->setUpdatedAt(Mage::getSingleton('core/date')->gmtDate());
    ...
    protected function _initUniqueFields() {
        ...
        $this->_uniqueFields = array(
            array(
                ...
                'title' => $this->_helper->__('In the same area, the building with the same default name')
            ),
        );
        return $this;
    }
