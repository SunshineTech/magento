...
$table = $installer->getConnection()
	...
	->addColumn('created_at', Varien_Db_Ddl_Table::TYPE_TIMESTAMP, null, array(
        ...
        ->addForeignKey($installer->getFkName('location/building', 'area_id', 'location/area', 'id'),
                    'area_id',  $installer->getTable('location/area'), 'id',
                    Varien_Db_Ddl_Table::ACTION_RESTRICT, Varien_Db_Ddl_Table::ACTION_NO_ACTION)
        ->addForeignKey($installer->getFkName('location/building', 'circle_id', 'location/area', 'id'),
                    'circle_id',  $installer->getTable('location/area'), 'id',
                    Varien_Db_Ddl_Table::ACTION_RESTRICT, Varien_Db_Ddl_Table::ACTION_NO_ACTION)
