...
abstract class SunshineBiz_Locale_Model_Resource_Abstract extends Mage_Core_Model_Resource_Db_Abstract {
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object) {
        ...
        if($newNames || $oldNames) {
            ...
            if ($insert) {
                ...
                $this->_getWriteAdapter()->insertMultiple($this->_nameTable, $data);
            }
            ...
            if ($deleteLocales) {
                ...
                $this->_getWriteAdapter()->delete($this->_nameTable, $where);
            }
            ...
            if($update) {
                foreach ($update as $name) {
                    ...
                    $this->_getWriteAdapter()->update($this->_nameTable, $name, $where);
                }
            }
        }
    ...
    public function getNameTable() {
        ...
        if (empty($this->_nameTable)) {
            Mage::throwException(Mage::helper('core')->__('Empty name table name'));
        }
    ...
    public function getFkFieldName() {
        ...
        if (empty($this->_fkFieldName)) {
            Mage::throwException(Mage::helper('core')->__('Empty foreign key field name'));
        }
