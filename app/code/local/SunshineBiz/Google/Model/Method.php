 ...
 */
class SunshineBiz_Google_Model_Method extends SunshineBiz_SocialConnect_Model_Method_Abstract {

    protected $_code = 'google';
    protected $_buttonBlockType = 'google/button';
    protected $_accountUrl = 'google/account/index';

    const REDIRECT_URI_ROUTE = 'google/connect/connect';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array()) {
        ...
        if ($response->isError()) {
            ...
            if (($status == 400 || $status == 401)) {
                ...
                throw new SunshineBiz_Google_OAuthException($message);
            } else {
                $message = sprintf(
    ...
    public function getDescription() {
        return Mage::helper('google')->__('You can login using your <strong>Google</strong> credentials.');
    }

    public function getTitle() {
        return Mage::helper('google')->__('Google Connect');
    }

}

class SunshineBiz_Google_OAuthException extends Exception {
