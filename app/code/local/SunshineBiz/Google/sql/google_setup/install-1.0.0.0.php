...
/**
 * Create table 'google_customer'
 */
$table = $installer->getConnection()
	->newTable($installer->getTable('google/customer'))
	...
	->addColumn('created_at', Varien_Db_Ddl_Table::TYPE_TIMESTAMP, null, array(
   	...
   	->addForeignKey($installer->getFkName('google/customer', 'customer_id', 'customer/entity', 'entity_id'),
		'customer_id',  $installer->getTable('customer/entity'), 'entity_id',
		Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_NO_ACTION)
    ->setComment('Google Customer Table');
